...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_grade'])) {
    ...
    $message = "Performance record for Certificate #{$student_id}-{$assignment_id} successfully synchronized.";
}
    ...
    <div class="flex-1 flex flex-col ml-0 md:ml-64 transition-all duration-300">
      ...
      <main class="p-6 lg:p-10">
        <div class="mb-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div>
                <h1 class="text-3xl font-black tracking-tight">Performance Audit</h1>
                <p class="text-slate-500 font-medium">Coordinate grading logic and academic certifications.</p>
            </div>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8 lg:p-12 mb-12">
            <div class="flex items-center gap-4 mb-10">
                ...
                <h2 class="text-xl font-black uppercase tracking-widest text-slate-900 text-sm">Award Performance Certification</h2>
            </div>

            <form method="POST" class="space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div>
                        <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-2">Diagnostic Task</label>
                        <select name="assignment_id" required class="w-full bg-slate-50 border-none rounded-2xl px-5 py-3 text-sm focus:ring-2 focus:ring-blue-600 font-bold text-slate-700">
                            <option value="">Identify Assessment...</option>
                    ...
                    <div>
                        <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-2">Target Student</label>
                    ...
                    <div>
                        <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-2">Obtained Points</label>
                    ...
                    <div>
                        <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-2">Total Capacity</label>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-8 border-b border-slate-50 flex justify-between items-center text-sm">
                <h3 class="font-black text-slate-900 uppercase tracking-widest text-xs">Performance Ledger</h3>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="bg-slate-50 border-b border-slate-100">
                        <tr>
                            <th class="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Candidate</th>
                            <th class="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">Diagnostic Meta</th>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        <?php if ($result && $result->num_rows > 0): ?>
                            ...
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr><td colspan="5" class="py-20 text-center font-bold italic text-slate-300">Digital ledger is currently vacant. No grading synchronized.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
