...
>>>>>>> b9fc0b0caa5737cb92934e15d7778649bf2a89a9
        ...
        <div class="relative w-full max-w-md">
            ...
            <input type="text" placeholder="Search..."
                class="w-full bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 transition">
        </div>
        ...
        <div class="relative flex-shrink-0">
            <a href="./profile.php" class="flex items-center gap-3 p-1.5 pr-4 bg-gray-50 hover:bg-gray-100 rounded-2xl border border-gray-200 transition cursor-pointer">
                ...
                <div class="hidden sm:block text-left">
                    ...
                    <p class="text-[9px] font-semibold text-gray-400 uppercase tracking-widest">Faculty</p>
                </div>
